...
import com.trailynsafe.app.api.LoginRequest
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.tvForgotPassword).setOnClickListener {
            startActivity(
                    Intent(
                            this,
                            com.trailynsafe.app.ui.auth.RecuperarPasswordActivity::class.java
                    )
            )
        }
        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    // Guardar sesión
                    val sessionManager =
                            com.trailynsafe.app.utils.SessionManager(this@LoginActivity)
                    ...
                    Toast.makeText(this@LoginActivity, "Credenciales inválidas", Toast.LENGTH_SHORT)
                            .show()
                }
            } catch (e: Exception) {
