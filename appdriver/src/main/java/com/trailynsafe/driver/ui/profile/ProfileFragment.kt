...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val cvSoporte = view.findViewById<View>(R.id.cvSoporte)
        cvSoporte?.setOnClickListener {
            val intent = android.content.Intent(requireContext(), SoporteActivity::class.java)
    ...
    private fun showLogoutConfirmation() {
        AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton("Sí") { _, _ -> (activity as? MainActivity)?.logout() }
