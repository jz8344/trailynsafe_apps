package com.trailynsafe.driver.ui.splash
...
import com.trailynsafe.driver.MainActivity
import com.trailynsafe.driver.R
import com.trailynsafe.driver.ui.welcome.WelcomeActivity
import com.trailynsafe.driver.utils.SessionManager

@SuppressLint("CustomSplashScreen")
class SplashActivity : AppCompatActivity() {
    
    private val splashTimeOut: Long = 3500 // 3.5 segundos
    ...
    private fun animateCircleOrbit(view: View, centerX: Float, centerY: Float, duration: Long, startAngle: Float) {
        ...
        animator.addUpdateListener { animation ->
            ...
            val x = centerX + (radius * Math.cos(angle)).toFloat() - view.width / 2
            val y = centerY + (radius * Math.sin(angle)).toFloat() - view.height / 2
    ...
    private fun animateHeartbeat(view: View) {
        ...
        beatSet.addListener(object : android.animation.Animator.AnimatorListener {
            ...
            override fun onAnimationEnd(animation: android.animation.Animator) {
                view.postDelayed({ animateHeartbeat(view) }, 1500)
            }
