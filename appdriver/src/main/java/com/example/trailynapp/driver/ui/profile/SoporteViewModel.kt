...
import com.example.trailynapp.driver.api.CrearTicketRequest
import com.example.trailynapp.driver.api.EnviarMensajeRequest
import com.example.trailynapp.driver.api.RetrofitClient
import com.example.trailynapp.driver.api.SoporteMensaje
...
class SoporteViewModel(private val context: Context) : ViewModel() {
    ...
    private val _tickets = MutableLiveData<List<com.example.trailynapp.driver.api.SoporteTicket>>()
    val tickets: LiveData<List<com.example.trailynapp.driver.api.SoporteTicket>>
        get() = _tickets
