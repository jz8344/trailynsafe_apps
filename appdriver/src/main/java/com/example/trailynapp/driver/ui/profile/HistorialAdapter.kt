...
import com.example.trailynapp.driver.api.SoporteTicket
...
class HistorialAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            tvTitle.setTextColor(view.resources.getColor(com.example.trailynapp.driver.R.color.m3_on_surface, null))
            tvSubtitle.setTextColor(view.resources.getColor(com.example.trailynapp.driver.R.color.m3_on_surface_variant, null))
        }
    }
}
